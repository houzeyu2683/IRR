...
# picture = express.scatter(reduction, x="x", y="y", text='word')
# picture.update_traces(textposition='top center', marker={'size':5}, textfont={'size':10})
# figure = make_subplots(rows=2, cols=2, subplot_titles=("w:15, d:50, e:20", "w:15, d:50, e:20"))
# figure.update_layout(height=1500, width=1000, title_text="近距離觀察")
# figure.add_trace(picture['data'][0], row=1, col=1)
# figure.show()
# reduction.type.unique()
